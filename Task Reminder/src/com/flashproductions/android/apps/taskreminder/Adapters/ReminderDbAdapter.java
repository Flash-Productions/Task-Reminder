...
public class ReminderDbAdapter extends Activity
{
    ...
    private static final String DATABASE_CREATE =
            ...
            " text not null, " + KEY_BODY + " text not null, " + KEY_DATE_TIME + " text not null);";
    ...
    {
        Cursor mCursor =
                mDb.query ( true, DATABASE_TABLE, new String[] { KEY_ROWID, KEY_TITLE, KEY_BODY, KEY_DATE_TIME },
